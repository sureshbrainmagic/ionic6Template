...
export class ErrormsgService {
  ...
  validationMSG = {
    ...
    chooseDate: [
      { type: 'required', message: 'Choose Date is required.' }
    ],
    dealerName: [
      { type: 'required', message: 'Dealer Name is required.' }
    ],
    followUps: [
      { type: 'required', message: 'Follow Ups is required.' }
    ],
    remarks: [
    ...
    leaveFromToDate: [
      { type: 'required', message: 'Choose Leave From and To Date.' }
    ],
    noticeTitle: [
      { type: 'required', message: 'Enter Notice Title' }
    ],
    noticeMessage: [
      { type: 'required', message: 'Enter Notice Message' }
    ]
  };
}
